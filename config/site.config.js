...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || '123@abc.com',
  ...
  links: [
    {
      name: '🌐 Website',
      link: 'https://www.tvphus.dev',
    },
    {
      name: 'GitHub',
      link: 'https://github.com/miyukowo',
    },
  ],
